...
import ru.levinov.modules.impl.render.JumpCircleFunction;
...
public interface ITextComponent extends Message, ITextProperties {
    ...
    default <T> Optional<T> func_230534_b_(IStyledTextAcceptor<T> acceptor, Style style) {
        if (Managment.FUNCTION_MANAGER != null && Managment.FUNCTION_MANAGER.nameProtect.state) {
            return acceptor.accept(style, Managment.FUNCTION_MANAGER.nameProtect.patch(this.getUnformattedComponentText()));
        }
    ...
    default <T> Optional<T> func_230533_b_(ITextAcceptor<T> acceptor) {
        if (Managment.FUNCTION_MANAGER != null && Managment.FUNCTION_MANAGER.nameProtect.state) {
            return acceptor.accept(Managment.FUNCTION_MANAGER.nameProtect.patch(this.getUnformattedComponentText()));
        }
