...
import ru.levinov.modules.impl.player.NoInteractFunction;
    ...
    public ActionResultType processRightClickBlock(ClientPlayerEntity player, ClientWorld worldIn, Hand hand, BlockRayTraceResult blockRayTraceResult) {
        ...
        if (!this.mc.world.getWorldBorder().contains(blockpos)) {
            ...
            if (this.currentGameType == GameType.SPECTATOR) {
                ...
                boolean flag2 = interactFunction.state && interactFunction.allBlocks.get() || interactFunction.state && interactFunction.getBlocks().contains(worldIn.getBlockState(blockRayTraceResult.getPos()).getBlockId()) ||  Managment.FUNCTION_MANAGER.auraFunction.getTarget() != null;
                if (!flag2) {
                    if (!flag1) {
