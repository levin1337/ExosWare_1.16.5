...
public class ServerList
{
    ...
    public void saveServerList()
    {
        try
        {
            ...
            {
                if (serverdata.serverIP.equalsIgnoreCase("mc.reallyworld.me")) continue;
    ...
    public void swapServers(int pos1, int pos2)
    {
        ...
        if (serverdata.serverIP.equalsIgnoreCase("mc.reallyworld.me")) {
            return;
        }
        if (this.getServerData(pos2).serverIP.equalsIgnoreCase("mc.reallyworld.me")) {
            return;
        }
