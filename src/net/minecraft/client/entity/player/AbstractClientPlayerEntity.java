...
import ru.levinov.waveycapes.CapeHolder;
import ru.levinov.waveycapes.sim.StickSimulation;
    ...
    public ResourceLocation getLocationCape()
    {
        ...
        if (this instanceof ClientPlayerEntity && !ClientUtil.legitMode) {
            if (this.hasCustomCape()) {
                if (Managment.FUNCTION_MANAGER.clickGui.capes.is("Cape")) {
                    return new ResourceLocation("client/images/capes/cape.png");
                }
                if (Managment.FUNCTION_MANAGER.clickGui.capes.is("Cape2")) {
                    return new ResourceLocation("client/images/capes/cape2.png");
                }
                if (Managment.FUNCTION_MANAGER.clickGui.capes.is("Cape3")) {
                    return new ResourceLocation("client/images/capes/cape3.png");
                }
                if (Managment.FUNCTION_MANAGER.clickGui.capes.is("Cape4")) {
                    long currentTime = System.currentTimeMillis();
                    int frameIndex = (int) ((currentTime / 155) % 58) + 1; // цикл с 1 до 58
                    return new ResourceLocation("client/images/capes/animationcape/" + frameIndex + ".jpeg");
                }
                if (Managment.FUNCTION_MANAGER.clickGui.capes.is("Cape5")) {
                    return new ResourceLocation("client/images/capes/cape5.png");
                }
                if (Managment.FUNCTION_MANAGER.clickGui.capes.is("Без плаща")) {
                }
            }
        }
