...
public class NewChatGui extends AbstractGui {
    ...
    private static final List<String> sentMessages = Lists.newArrayList();
    private static final List<ChatLine<ITextComponent>> chatLines = Lists.newArrayList();
    private static final List<ChatLine<IReorderingProcessor>> drawnChatLines = Lists.newArrayList();
    private static final Deque<ITextComponent> field_238489_i_ = Queues.newArrayDeque();
     ...
     */
    public static void clearChatMessages(boolean clearSentMsgHistory) {
        field_238489_i_.clear();
    ...
    public void printChatMessageWithOptionalDeletion(ITextComponent chatComponent, int chatLineId) {
        ...
        LOGGER.info("[×àò] {}", (Object) chatComponent.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n"));
    }
