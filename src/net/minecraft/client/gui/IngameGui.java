...
import ru.levinov.command.impl.GPSCommand;
...
import ru.levinov.modules.impl.render.Crosshair;
...
public class IngameGui extends AbstractGui {
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
        ...
        Crosshair crosshair = Managment.FUNCTION_MANAGER.crosshair;
        ...
        if (Managment.FUNCTION_MANAGER.hud2.elements.get(5)) {
            Managment.NOTIFICATION_MANAGER.draw(matrixStack);
        }
    ...
    private void func_238447_a_(MatrixStack p_238447_1_, ScoreObjective p_238447_2_) {
        ...
        int l = 0;
        RenderUtil.Render2D.drawRoundedCorner(l2, j2 - i2, scaledWidth - l2, i2, new Vector4f(0, 0, 0, 0), ColorUtil.rgba(0, 0, 0, 80));
        ...
        for (Pair<Score, ITextComponent> pair : list1) {
            ...
            if (l == collection.size()) {
                ...
                RenderUtil.Render2D.drawRoundedCorner(l2, k1 - 10, scaledWidth - l2, 10, new Vector4f(0, 0, 0, 0), ColorUtil.rgba(0, 0, 0, 128));
