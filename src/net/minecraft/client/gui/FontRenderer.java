...
public class FontRenderer
{
    ...
    private float func_238426_c_(IReorderingProcessor p_238426_1_, float p_238426_2_, float p_238426_3_, int color, boolean p_238426_5_, Matrix4f p_238426_6_, IRenderTypeBuffer p_238426_7_, boolean p_238426_8_, int p_238426_9_, int p_238426_10_)
    {
        CharacterRenderer fontrenderer$characterrenderer = new CharacterRenderer(p_238426_7_, p_238426_2_, p_238426_3_, color, p_238426_5_, p_238426_6_, p_238426_8_, p_238426_10_);
    ...
    class CharacterRenderer implements ICharacterConsumer
    {
        ...
        public CharacterRenderer(IRenderTypeBuffer p_i232250_2_, float p_i232250_3_, float p_i232250_4_, int color, boolean p_i232250_6_, Matrix4f p_i232250_7_, boolean p_i232250_8_, int p_i232250_9_)
        {
            ...
            this.field_238431_e_ = (float)(color >> 16 & 255) / 255.0F * this.field_238430_d_;
            this.field_238432_f_ = (float)(color >> 8 & 255) / 255.0F * this.field_238430_d_;
            this.field_238433_g_ = (float)(color & 255) / 255.0F * this.field_238430_d_;
