...
public class PlayerTabOverlayGui extends AbstractGui {
    ...
    public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
        ...
        int k4;
        //TabTable
        if (Managment.FUNCTION_MANAGER.extendedTab.state) {
            for (k4 = (int) Managment.FUNCTION_MANAGER.extendedTab.column.getValue().floatValue() - 1; j4 > Managment.FUNCTION_MANAGER.extendedTab.quantity.getValue().floatValue(); j4 = (i4 + k4 - 1) / k4) {
               ++k4;
            }
    ...
    protected void func_238522_a_(MatrixStack p_238522_1_, int p_238522_2_, int p_238522_3_, int p_238522_4_, NetworkPlayerInfo p_238522_5_) {
        ...
        Fonts.minecraft[8].drawStringWithOutline(p_238522_1_, ping, (p_238522_3_ + p_238522_2_ - 2 - Fonts.minecraft[8].getWidth(ping)), (float) p_238522_4_ + 5.5f, j);
