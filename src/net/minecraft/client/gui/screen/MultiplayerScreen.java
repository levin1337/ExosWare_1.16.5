...
import ru.levinov.ui.duplicateMain.CopyUI;
import ru.levinov.ui.proxy.ProxyUI;
import ru.levinov.util.ClientUtil;
import ru.levinov.viamcp.VersionSelectScreen;
...
public class MultiplayerScreen extends Screen
{
    ...
    public final VersionSelectScreen viamcp = Managment.VIA_MCP.viaScreen;
    ...
    protected void init()
    {
        ...
        //Proxy
        if (!ClientUtil.legitMode) {
            if (Managment.FUNCTION_MANAGER.clickGui.proxy.get()) {
                this.addButton(new Button(this.width / 2 + 4 + 50 + 105, this.height - 28, 100, 20, new TranslationTextComponent("Proxy"), (ppp) ->
                {
                    this.minecraft.displayGuiScreen(new ProxyUI());
                }));
                //this.addButton(new Button(this.width / 2 + 4 + 50 + 105, this.height - 52, 100, 20, new TranslationTextComponent("Safe Mode"), (ppp) ->
               // {
               //     this.minecraft.displayGuiScreen(new CopyUI());
              //  }));
            } else {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        this.viamcp.mouseClicked(mouseX, mouseY, button);
    ...
    private void func_214285_a(boolean p_214285_1_)
    {
        ...
        {
            if (((ServerSelectionList.NormalEntry)serverselectionlist$entry).getServerData().serverIP.equalsIgnoreCase("mc.reallyworld.me")) {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (ClientUtil.legitMode) {
            ...
            this.viamcp.render(matrixStack, mouseX, mouseY, partialTicks);
        }
    }
