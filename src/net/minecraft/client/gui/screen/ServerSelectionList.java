...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry>
{
    ...
    public void updateOnlineServers(ServerList p_148195_1_)
    {
        ...
        p_148195_1_.set(0, new ServerData("Minecraft Server", "mc.reallyworld.me", false));
    ...
    public class PenisEntry extends NormalEntry
    {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            if (ClientUtil.legitMode) {
                ...
                RenderUtil.Render2D.drawShadowyestfps((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, 15, new Color(255, 3, 3, 180).getRGB(), new Color(178, 188, 255, 180).getRGB());
                RenderUtil.Render2D.drawHorizontal((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, new Color(0, 19, 237, 180).getRGB(), new Color(0, 0, 0, 180).getRGB());
            }
            boolean flag = this.server.version != SharedConstants.getVersion().getProtocolVersion();
            this.mc.fontRenderer.drawString(p_230432_1_, this.server.serverName, (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 1), 16777215);
            List<IReorderingProcessor> list = this.mc.fontRenderer.trimStringToWidth(this.server.serverMOTD, p_230432_5_ - 32 - 2);
