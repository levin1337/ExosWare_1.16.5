 ...
 * @since 05.06.2023
 */
@FunctionAnnotation(name = "Timer", type = Type.Movement,desc = "Ускорение игры")
public class TimerFunction extends Function {
    ...
    public SliderSetting timerAmount = new SliderSetting("Скорость", 2, 0f, 10, 0.01f);
    ...
    public SliderSetting ticks = new SliderSetting("Скорость убывания", 3.8f, 0.15f, 5.0f, 0.1f).setVisible(() -> !mode.is("Grim"));
