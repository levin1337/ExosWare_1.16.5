...
@FunctionAnnotation(name = "BackTrack", type = Type.Combat,desc = "Позволяет бить дальше")
public class BackTrack extends Function {
    ...
    private final SliderSetting timeout = new SliderSetting("Время", 5000, 100, 10000, 100);
    private final BooleanOption draw = new BooleanOption("Рисовать позицию", true);
