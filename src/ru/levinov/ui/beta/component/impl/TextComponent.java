...
public class TextComponent extends Component {
    ...
    public void drawComponent(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        RenderUtil.Render2D.drawRoundedCorner(x + 5, y + 2, width, 10, 2, isTyping ? ColorUtil.getColorStyle(60) : new Color(0, 0, 0).brighter().getRGB());
        ...
        RenderUtil.Render2D.drawRoundedCorner(x + 5, y + 12,width,1,2,Color.WHITE.getRGB());
    }
