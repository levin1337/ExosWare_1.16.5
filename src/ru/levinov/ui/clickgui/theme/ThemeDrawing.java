...
public class ThemeDrawing {
    ...
    public void draw(MatrixStack stack, int mouseX, int mouseY, float x,float y,float width ,float height) {
        ...
        BloomHelper.registerRenderCall(() -> {
            RenderUtil.Render2D.drawImage(new ResourceLocation("client/images/rect2.png"), x - 10.5F + width - 345 / 2f, y + height - 49.5F, 345 / 2f, 69 / 2f,  new Vector4i(
        ...
        RenderUtil.Render2D.drawImage(new ResourceLocation("client/images/rect2.png"), x - 10.5F + width - 345 / 2f, y + height - 49.5F, 345 / 2f, 69 / 2f, colors);
        ...
        if (openAnimation > 0.01) {
            ...
            GlStateManager.translated(-(x - 10.5F + width - 15  + 3.5F), -(y + height - 14 - 16 + 3.5F), 0);
            Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("client/images/back1.png"));

            RenderUtil.Render2D.drawTexture(x + width + 20, y + height - 315 / 2f, 130, 315 / 2f, 15, 1);
            RenderUtil.Render2D.drawImage(new ResourceLocation("client/images/corner.png"), colorX + 8 + 25, colorY + 7 + (edit == 1 ? -2 : 0), 34, 23, custom.colors[1]);
            RenderUtil.Render2D.drawImage(new ResourceLocation("client/images/corner.png"), colorX + 8, colorY + 7 + (edit == 0 ? -2 : 0), 34, 23, custom.colors[0]);
