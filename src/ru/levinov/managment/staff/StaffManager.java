package ru.levinov.managment.staff;
...
public class StaffManager {
    ...
    public static final File file = new File(Minecraft.getInstance().gameDir, "\\files\\staff.ew");
    ...
    public void reload() {
        staffNames.clear(); // ќчищаем текущий список
        readFriends(); // —читываем заново из файла
    }
