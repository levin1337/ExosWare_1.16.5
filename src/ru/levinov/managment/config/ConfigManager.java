...
public final class ConfigManager {
    ...
    public static final File CONFIG_DIR = new File(Minecraft.getInstance().gameDir, "\\files\\configs");
    private final File autoCfgDir = new File(Minecraft.getInstance().gameDir, "\\files\\configs\\autocfg.cfg");
