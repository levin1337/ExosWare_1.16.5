...
public class ShaderUtils implements IMinecraft {
    ...
    public void setUniform(String string, float... fArray) {
        ...
        switch (fArray.length) {
            case 1 -> ARBShaderObjects.glUniform1fARB(n, fArray[0]);
            case 2 -> ARBShaderObjects.glUniform2fARB(n, fArray[0], fArray[1]);
            case 3 -> ARBShaderObjects.glUniform3fARB(n, fArray[0], fArray[1], fArray[2]);
            case 4 -> ARBShaderObjects.glUniform4fARB(n, fArray[0], fArray[1], fArray[2], fArray[3]);
        }
    ...
    private int createShader(String string) {
        ...
        GL20.glShaderSource(gled, FileUtil.readInputStream(new ByteArrayInputStream(string.getBytes())));
