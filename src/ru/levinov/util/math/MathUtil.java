...
public class MathUtil implements IMinecraft {
    ...
    public static float clamp01(float x) {
        return (float)clamp222(0.0, 1.0, (double)x);
    }
    public static double clamp222(double min, double max, double n) {
    ...
    public static double getScaleT(Vector3d position, double size){
