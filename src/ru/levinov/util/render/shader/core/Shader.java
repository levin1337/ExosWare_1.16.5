package ru.levinov.util.render.shader.core;
...
import ru.levinov.util.misc.FileUtil;
...
public class Shader {
    ...
    public Shader(String path) {
        init(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("client/shader/impl/" + path + ".frag")).getInputStream()));
    }
    ...
    private void init(String source) {
        ...
        ARBShaderObjects.glAttachObjectARB(program, createShader(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("client/shader/vertex.vert")).getInputStream()), GL_VERTEX_SHADER));
