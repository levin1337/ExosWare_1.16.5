...
public class ShaderUtil implements IMinecraft {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        ...
        try {
            ...
            int fragmentShaderID = switch (fragmentShaderLoc) {
                ...
                default ->
                        createShader(mc.getResourceManager().getResource(new ResourceLocation("client/shader/" + fragmentShaderLoc)).getInputStream(), GL_FRAGMENT_SHADER);
            };
    ...
    public static void init() {
        ...
        FACE_ROUND = new ShaderUtil("faceRound");
    }
